...
let coinToBeans = (new Date().getHours()==0?1000:20); //兑换多少数量的京豆（20或者1000），0表示不兑换，默认不兑换京豆，如需兑换把0改成20或者1000，或者'商品名称'(商品名称放到单引号内)即可
console.log("兑换京豆数量：coinToBeans="+coinToBeans)
