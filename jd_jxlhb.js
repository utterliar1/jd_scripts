...
[task_local]
#京喜领88元红包
2 0,12 * * * https://raw.githubusercontent.com/KingRan/JDJB/main/jd_jxlhb.js, tag=京喜领88元红包, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

==============Loon==============
[Script]
cron "2 0,12 * * *" script-path=https://raw.githubusercontent.com/KingRan/JDJB/main/jd_jxlhb.js,tag=京喜领88元红包

================Surge===============
京喜领88元红包 = type=cron,cronexp="2 0,12 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/KingRan/JDJB/main/jd_jxlhb.js

===============小火箭==========
京喜领88元红包 = type=cron,script-path=https://raw.githubusercontent.com/KingRan/JDJB/main/jd_jxlhb.js, cronexpr="2 0,12 * * *", timeout=3600, enable=true
 */
...
!(async () => {
  ...
  let res = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/atyvcn/updateTeam@master/shareCodes/jd/jxhb.json')
  if (!res) {
    await $.wait(1000)
  ...
  if( $.authorMyShareIds && $.authorMyShareIds.length ) {
    ...
    if( $.authorMyShareIds[0] && $.authorMyShareIds[0]["userName"] ) $.packetIdArr=$.authorMyShareIds.concat($.packetIdArr);
  }
