...
# 半点京豆雨
30,31 16-23 * * * node /scripts/jd_half_redrain.js >> /scripts/logs/long_half_redrain.log 2>&1
&1
# 整点京豆雨
0,1 16-23 * * * node /scripts/jd_super_redrain.js >> /scripts/logs/long_super_redrain.log 2>&1
