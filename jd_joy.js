...
function getDeskGoodDetails() {
  return new Promise(resolve => {
    ...
    const reqSource = 'h5';
    let opt = {
      url: "//jdjoy.jd.com/common/pet/getDeskGoodDetails?invokeKey=q8DNJdpcfRQ69gIx",
      method: "GET",
      data: {},
      credentials: "include",
...
function followScan(sku) {
  return new Promise(resolve => {
    ...
    let opt = {
      url: "//jdjoy.jd.com/common/pet/scan?invokeKey=q8DNJdpcfRQ69gIx",
      method: "POST",
      data: body,
      credentials: "include",
      header: {"content-type": "application/json"}
...
function scanMarket(type, body, cType = 'application/json') {
  return new Promise(resolve => {
    ...
    let opt = {
      url: `//draw.jdfcloud.com/common/pet/${type}?invokeKey=q8DNJdpcfRQ69gIx`,
      method: "POST",
      data: body,
      credentials: "include",
...
function doScanMarket(type, body) {
  return new Promise(resolve => {
    ...
    const reqSource = 'weapp';
    let opt = {
      url: `//draw.jdfcloud.com/common/pet/icon/click?iconCode=${type}&linkAddr=${body}&invokeKey=q8DNJdpcfRQ69gIx`,
      method: "GET",
      credentials: "include",
      header: {"content-type": "application/json"}
    }
...
function appScanMarket(type, body) {
  return new Promise(resolve => {
    ...
    const reqSource = 'h5';
    let opt = {
      url: `//jdjoy.jd.com/common/pet/${type}?invokeKey=q8DNJdpcfRQ69gIx`,
      method: "POST",
      data: body,
      credentials: "include",
      header: {"content-type": "application/json"}
...
function getFood(type) {
  return new Promise(resolve => {
    ...
    const reqSource = 'weapp';
    let opt = {
      url: `//draw.jdfcloud.com/common/pet/getFood?taskType=${type}&invokeKey=q8DNJdpcfRQ69gIx`,
      method: "GET",
      data: {},
      credentials: "include",
      header: {"content-type": "application/json"}
...
function followShop(shopId) {
  return new Promise(resolve => {
    ...
    const host = 'draw.jdfcloud.com';
    let opt = {
      url: "//draw.jdfcloud.com/common/pet/followShop?invokeKey=q8DNJdpcfRQ69gIx",
      method: "POST",
      data: body,
      credentials: "include",
...
function dofollowShop(shopId) {
  return new Promise(resolve => {
    ...
    const host = 'draw.jdfcloud.com';
    let opt = {
      url: `//draw.jdfcloud.com/common/pet/icon/click?iconCode=follow_shop&linkAddr=${shopId}&invokeKey=q8DNJdpcfRQ69gIx`,
      method: "GET",
      credentials: "include",
      header: {"content-type":"application/x-www-form-urlencoded"}
    }
...
function appGetPetTaskConfig() {
  return new Promise(resolve => {
    ...
    const reqSource = 'h5';
    let opt = {
      url: "//jdjoy.jd.com/common/pet/getPetTaskConfig?invokeKey=q8DNJdpcfRQ69gIx",
      method: "GET",
      data: {},
      credentials: "include",
      header: {"content-type": "application/json"}
...
function feedPets(feedNum) {
  return new Promise(resolve => {
    ...
    const reqSource = 'weapp';
    let opt = {
      url: `//draw.jdfcloud.com/common/pet/feed?feedCount=${feedNum}&invokeKey=q8DNJdpcfRQ69gIx`,
      method: "GET",
      data: {},
      credentials: "include",
      header: {"content-type": "application/json"}
...
function getPetTaskConfig() {
  return new Promise(resolve => {
    ...
    const reqSource = 'weapp';
    let opt = {
      url: "//draw.jdfcloud.com//common/pet/getPetTaskConfig?invokeKey=q8DNJdpcfRQ69gIx",
      method: "GET",
      data: {},
      credentials: "include",
      header: {"content-type": "application/json"}
...
function getPetRace() {
  return new Promise(resolve => {
    ...
    const reqSource = 'h5';
    let opt = {
      url: "//jdjoy.jd.com/common/pet/combat/detail/v2?help=false&invokeKey=q8DNJdpcfRQ69gIx",
      method: "GET",
      data: {},
      credentials: "include",
      header: {"content-type": "application/json"}
...
function getRankList() {
  return new Promise(resolve => {
    ...
    $.raceUsers = [];
    let opt = {
      url: "//jdjoy.jd.com/common/pet/combat/getRankList?invokeKey=q8DNJdpcfRQ69gIx",
      method: "GET",
      data: {},
      credentials: "include",
      header: {"content-type": "application/json"}
...
function runMatch(teamLevel, timeout = 5000) {
  ...
  return new Promise(async resolve => {
    ...
    const reqSource = 'h5';
    let opt = {
      url: `//jdjoy.jd.com/common/pet/combat/match?teamLevel=${teamLevel}&invokeKey=q8DNJdpcfRQ69gIx`,
      method: "GET",
      data: {},
      credentials: "include",
      header: {"content-type": "application/json"}
...
function getBackupInfo() {
  return new Promise(resolve => {
    ...
    const reqSource = 'h5';
    let opt = {
      url: "//jdjoy.jd.com/common/pet/combat/getBackupInfo?invokeKey=q8DNJdpcfRQ69gIx",
      method: "GET",
      data: {},
      credentials: "include",
      header: {"content-type": "application/json"}
...
function getWinCoin() {
  return new Promise(resolve => {
    ...
    let opt = {
      url: "//draw.jdfcloud.com/common/pet/combat/detail/v2?help=false&invokeKey=q8DNJdpcfRQ69gIx",
      method: "GET",
      data: {},
      credentials: "include",
      header: {"content-type": "application/json"}
...
function receiveJoyRunAward() {
  return new Promise(resolve => {
    ...
    const reqSource = 'h5';
    let opt = {
      url: "//jdjoy.jd.com/common/pet/combat/receive?invokeKey=q8DNJdpcfRQ69gIx",
      method: "GET",
      data: {},
      credentials: "include",
      header: {"content-type": "application/json"}
...
function getSupplyInfo(showOrder) {
  return new Promise(resolve => {
    ...
    let opt = {
      url: `//draw.jdfcloud.com/common/pet/combat/getSupplyInfo?showOrder=${showOrder}&invokeKey=q8DNJdpcfRQ69gIx`,
      method: "GET",
      data: {},
      credentials: "include",
      header: {"content-type": "application/json"}
